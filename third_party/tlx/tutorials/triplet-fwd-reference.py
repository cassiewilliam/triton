...
def _gqa_pack_fwd_kernel(
    ...
    """GQA triplet fwd kernel. Assume TP so kernel is called per kv_group."""
    # TODO support kv_group_size not power of 2.
...
def block_local_triplet_attn_fwd_gqa_pack(
    q, k1, k2, v1, v2, w1, w2, k2_bias=None, v2_bias=None
):
